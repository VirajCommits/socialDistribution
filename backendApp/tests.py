...
class identityTests(TestCase):
    ...
    def test_author_id_page(self):      # Identity1, Identity3
        ...
        self.assertEqual(author.id, f"https://social-distribution-1-3adb84f120d9.herokuapp.com/authors/{author.uuid}")
        self.assertEqual(author.page, f"https://social-distribution-1-3adb84f120d9.herokuapp.com/authors/{author.username}")
    ...
    def test_multiple_authors(self):        # Identity2
        ...
        expected_host = "https://social-distribution-1-3adb84f120d9.herokuapp.com/authors/"
